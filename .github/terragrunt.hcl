...
remote_state {
  backend = "s3"
  config = {
    bucket  = "project-78bf2621-6ba3-4cd7-963a-058179ce0ef9-eu-north-1"
    key     = "dfhfdjfhj/terraform.tfstate"
    region  = "eu-north-1"
    encrypt = true
    dynamodb_table = "project-78bf2621-6ba3-4cd7-963a-058179ce0ef9-eu-north-1"
  }
}
...
terraform {
  backend "s3" {
    bucket  = "project-78bf2621-6ba3-4cd7-963a-058179ce0ef9-eu-north-1"
    key     = "project-78bf2621-6ba3-4cd7-963a-058179ce0ef9-eu-north-1/terraform.tfstate"
    region  = "eu-north-1"
    encrypt = true
    dynamodb_table = "project-78bf2621-6ba3-4cd7-963a-058179ce0ef9-eu-north-1"
  }
